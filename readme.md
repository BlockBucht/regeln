...
- **Absatz 2:** Die Nutzung des Netzwerkes setzt die Zustimmung zu diesem Regelwerk voraus.

### § 1.3 Grundsätze

#### § 1.3.1 Namensgebung
- **Absatz 1:** Wir bitten alle User, auf dem gesamten Netzwerk den gleichen Usernamen zu verwenden, den sie in Minecraft nutzen.
- **Absatz 2:** Das Faken von Teammitgliedern, YouTubern und anderen Personen ist untersagt.
...
- **Absatz 3:** Vorbehalte der Teammitglieder
    - **Absatz 3.1:** Jedes Teammitglied von BlockBucht.de hat volles Weisungsrecht. Wer sich Anweisungen von Teammitgliedern widersetzt, muss mit einem temporären Ausschluss vom Netzwerk-Bereich rechnen.
    ...
    - **Absatz 3.7:** Jedes Teammitglied des BlockBucht.de Netzwerkes ist befugt, jederzeit von seinen Rechten Gebrauch zu machen und User mit diesen zu kontrollieren.
...
- **Absatz 2:** Modifikationen
    - **Absatz 2.1:** Erlaubte Modifikationen umfassen Chatmodifikationen, Dynamic Lights, Shader Mod, LabyMod, OptiFine, MorePlayerModels, NoRisk und Resource Packs, sofern sie nicht als X-Ray oder in ähnlicher Weise zur unfairen Vorteilsverschaffung genutzt werden. Physische Modifikationen an deinen Eingabegeräten, die dir im Spiel Vorteile verschaffen, sind nicht erlaubt.
...
- **Absatz 11:** Chatverhalten
    ...
    - **Absatz 11.8:** Das Posten von Links im Chat ist untersagt, außer es handelt sich um offizielle Links von BlockBucht.de.
